...
class brandTests {
    async runAll(PORT, adminToken) {
        this.path = 'http://localhost:'+PORT+'/api/brand/';
    ...
    async createNewTest(){        
        ...
        //CORRECT DATA TEST
        {
            ...
            try{
                ...
                {
                    this.successBrand = result.body.id;
                    logger.printSuccess(this.component+testName+ 'SUCCESS');
                }
    ...
    async getAllTest()
    {
        //CORRECT TEST
        {
            ...
            try{
                ...
                {
                    if(!result.body.find(e=>{return e.id==this.successBrand}) )
                    {
